...
public class SellerNetwork {
     ...
     * @param sellerId ID của Seller
     * @return Response chứa danh sách lịch sử chuyển tiền
     */
    public CompletableFuture<Response> getTransferHistory(long sellerId) {
        HttpRequest request = NetworkClient.newRequestBuilder(URI.create(BASE_URL + "/" + sellerId + "/transfer-history"))
                .GET()
                .build();
