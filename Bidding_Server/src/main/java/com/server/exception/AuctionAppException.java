...
public class AuctionAppException extends AppException {
    ...
    public static AuctionAppException from(AuctionException e) {
        ...
        int status = switch (code) {
            case AUCTION_NOT_FOUND, AUCTION_NOT_ACTIVE, AUTO_BID_NOT_FOUND -> 404;
            case INVALID_REQUEST, INVALID_BID_AMOUNT, BID_AMOUNT_TOO_LOW, INVALID_AUTO_BID_CONFIG -> 400;
